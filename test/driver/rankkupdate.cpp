...
int main() {
    ...
    CHECK_CUDA(cuMemcpyHtoD(d_C, h_C, size_C));

    CUmodule module;
    CUfunction kernel;
    CHECK_CUDA(cuModuleLoad(&module, "ptx/matrix_rank_k_update.ptx"));
    CHECK_CUDA(cuModuleGetFunction(&kernel, module, "_Z11syrk_kernelPfS_iiff"));
    ...
    void* args[] = { &d_A, &d_C, &N, &K, &alpha, &beta };
